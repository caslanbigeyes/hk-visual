    ...
    <div className="p-6 h-[552px]  bg-[#24263A] rounded-tl-[30px] rounded-br-[30px] rounded-tr-[30px] rounded-bl-[30px]">
        ...
        <div className="w-1/2">
          <div className="mt-4">
            ...
            <p className="font-bold text-[40px] text-[rgb(255,255,255)]  max-w-16 inline">
              <CountUp start={0} end={formatCount(Number(chargeCount))} />{chargeCount > 1000 ? <span>{'K'}</span> : null}
            </p>
          </div>
        </div>
      ...
      <div className='flex justify-center items-center'>
        ...
        <div className="w-1/2">
          ...
          <p className="font-bold text-[40px] text-[#FFFFFF]  max-w-16 inline">
            <CountUp start={0} end={formatCount(Number(chargePayTotalcount), 'total')} />{chargePayTotalcount > 10000000 ? <span>{'K'}</span> : null}
          </p>
        </div>
      </div>
